...
# -*- coding: utf-8 -*-
#
# ipyaudioworklet documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipyaudioworklet', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipyaudioworkletdoc'
...
latex_documents = [
    (master_doc, 'ipyaudioworklet.tex', 'ipyaudioworklet Documentation',
     'Sunao Hara', 'manual'),
]
